...
/***/ (function(module, exports, __webpack_require__) {
	...
	var game = __webpack_require__(12); // was ('./game')
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var loadGame = function loadGame(event) {
	  event.preventDefault();
	  gameApi.loadGamePage().then(gameUi.onSigninSuccess).catch(gameUi.onSigninFailure);
	};
	...
	var registerUser = function registerUser(event) {
	  ...
	  if (data.credentials.password !== data.credentials.password_confirmation) {
	    ...
	    gameApi.addUser(data).then(gameUi.onSignupSuccess).catch(gameUi.onSignupFailure);
	  }
	};
	...
	var loginUser = function loginUser(event) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  gameApi.userLogin(data).then(gameUi.onSigninSuccess).catch(gameUi.onSigninFailure);
	};

	var resetPassword = function resetPassword(event) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  gameApi.passwordReset(data).then(gameUi.onResetSuccess).catch(gameUi.onResetFailure);
	};

	var logoutUser = function logoutUser(event) {
	  var data = getFormFields(this);
	  event.preventDefault();
	  gameApi.userLogout().then(gameUi.onLogoutSuccess).catch(gameUi.onLogoutFailure);
	};

	var newGame = function newGame(event) {
	  event.preventDefault();
	  gameApi.createGame().then(gameUi.newGameCreated).catch(gameUi.newGameFail);
	};
	...
	var playGame = function playGame(event) {
	  ...
	  gameApi.getGame().then(gameUi.onGetGameSuccess).catch(gameUi.onGetGameFail);
	};

	var updateGameStates = function updateGameStates(index, value, over) {
	  // event.preventDefault()
	  var data = getFormFields(event.target);
	  // console.log('on updateGameState')
	  gameApi.moves(index, value, over).then(gameUi.updateGameStatesSuccess).catch(gameUi.updateGameStatesFail);
	...
	var onGetUser = function onGetUser(event) {
	  event.preventDefault();
	  ...
	  if (games.id.length > 0) {
	    ...
	    gameApi.show(games.id).then(gameUi.onSuccess).catch(gameUi.onError);
	  } else {
	...
	var viewGames = function viewGames() {
	  event.preventDefault();
	  gameApi.gameViews().then(gameUi.onViewSuccess).catch(gameUi.onViewError);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var loadLogPage = function loadLogPage() {};

	var loadRegPage = function loadRegPage() {};

	var loadGamePage = function loadGamePage() {
	  return $.ajax({
	    url: app.host,
	    method: 'GET'
	  });
	...
	var createGame = function createGame(data) {
	  ...
	  return $.ajax({
	    ...
	    // found in issue tracker
	    // console.log('Response is ', response)
	    app.game.id = response.game.id;
	  });
	};

	var moves = function moves(index, value, over) {
	...
	var gameViews = function gameViews() {
	  // console.log(app.user.token)
	  // console.log(games.length)
	  return $.ajax({
	    url: app.host + '/games',
	...
	module.exports = {
	  index: index,
	  show: show,
	  loadLogPage: loadLogPage,
	  loadRegPage: loadRegPage,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var updateGameStatesSuccess = function updateGameStatesSuccess(index, value) {
	  // console.log(app.gameID)
	  // console.log('testing update game states success')
	};

	var updateGameStatesFail = function updateGameStatesFail(index, value) {
	  // console.log(app.gameID)
	...
	var onGameSuccess = function onGameSuccess() {
	  // $('#play-game').hide()
	  // $('#board').show()
	  // $('#game-buttons').show()
	...
	var onGameFail = function onGameFail(error) {};

	var onSuccessAllUsers = function onSuccessAllUsers(data) {
	  console.table(data.games);
	};

	var onErrorAllUsers = function onErrorAllUsers(response) {
	...
	var onGetGameFail = function onGetGameFail() {
	  // console.log('got game failed')
	};

	var onViewSuccess = function onViewSuccess(data) {
	...
	var getPassChange = function getPassChange() {
	  $('#passChange').show();
	};

	// if view games fails
	var onViewError = function onViewError() {
	  // console.error(error)
	...
	module.exports = {
	  ...
	  onGetGameFail: onGetGameFail,
	  onSuccessAllUsers: onSuccessAllUsers,
	  onErrorAllUsers: onErrorAllUsers,
	  ...
	  updateGameStatesSuccess: updateGameStatesSuccess,
	  updateGameStatesFail: updateGameStatesFail,
	  // displayErrorMessage,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var playerToken = 'x';
	var count = parseInt($(undefined).data('click')) || 0;
	var xWin = 1;
	var oWin = 1;
	var over = void 0;
	// let games won = game
	...
	var calculateWinsX = function calculateWinsX() {
	  xWin = xWin + 1;
	  return xWin;
	};

	var calculateWinsO = function calculateWinsO() {
	  oWin = oWin + 1;
	  return oWin;
	};
	...
	*/
	var checkIfPlayerWon = function checkIfPlayerWon(symbol) {
	  if ($('#r1').hasClass('square-x') && $('#r2').hasClass('square-x') && $('#r3').hasClass('square-x') || $('#r4').hasClass('square-x') && $('#r5').hasClass('square-x') && $('#r6').hasClass('square-x') || $('#r7').hasClass('square-x') && $('#r8').hasClass('square-x') && $('#r9').hasClass('square-x') || $('#r1').hasClass('square-x') && $('#r5').hasClass('square-x') && $('#r9').hasClass('square-x') || $('#r3').hasClass('square-x') && $('#r5').hasClass('square-x') && $('#r7').hasClass('square-x') || $('#r1').hasClass('square-x') && $('#r4').hasClass('square-x') && $('#r7').hasClass('square-x') || $('#r2').hasClass('square-x') && $('#r5').hasClass('square-x') && $('#r8').hasClass('square-x') || $('#r3').hasClass('square-x') && $('#r6').hasClass('square-x') && $('#r9').hasClass('square-x')) {
	    // updateGame()
	    ...
	    playerToken = 'x';
	    return 'square-x';
	  } else if ($('#r1').hasClass('square-o') && $('#r2').hasClass('square-o') && $('#r3').hasClass('square-o') || $('#r4').hasClass('square-o') && $('#r5').hasClass('square-o') && $('#r6').hasClass('square-o') || $('#r7').hasClass('square-o') && $('#r8').hasClass('square-o') && $('#r9').hasClass('square-o') || $('#r1').hasClass('square-o') && $('#r5').hasClass('square-o') && $('#r9').hasClass('square-o') || $('#r3').hasClass('square-o') && $('#r5').hasClass('square-o') && $('#r7').hasClass('square-o') || $('#r1').hasClass('square-o') && $('#r4').hasClass('square-o') && $('#r7').hasClass('square-o') || $('#r2').hasClass('square-o') && $('#r5').hasClass('square-o') && $('#r8').hasClass('square-o') || $('#r3').hasClass('square-o') && $('#r6').hasClass('square-o') && $('#r9').hasClass('square-o')) {
